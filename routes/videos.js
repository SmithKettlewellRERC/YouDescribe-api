...
router.get("/search", webVisitCounter, videosController.search);
router.get("/searchbykeyword", adminTokenValidator, videosController.searchByKeyword);
router.get("/:id", videoVisitCounter, videosController.getOne);
router.get("/user/:userId", webVisitCounter, videosController.getVideosByUserId);
